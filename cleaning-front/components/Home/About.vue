    ...
    <section class="w-full max-w-[1500px] mx-auto mt-[150px]" id="About">
        <div class="flex justify-between">
            ...
            <div class="max-w-[700px]">
                ...
                <p class="text-[#5A5A5A] text-[18px] font-normal leading-[180%] mt-[45px]">
                    Компания «Ocean» - команда профессиональных клинеров по уборке жилых и нежилых помещений в
                    Нижневартовске.
                </p>
                <p class="text-[#5A5A5A] text-[18px] font-normal leading-[180%] mt-5">Работаем с 2017 года. За это время мы
                    обслужили 17 000 м2 и провели 600 уборок разного уровня сложности.</p>
                <p class="text-[#5A5A5A] text-[18px] font-normal leading-[180%] mt-5">Наши мастера клининга умеют работать с
                ...
                <button
                    ...
                    <div class="flex items-center">
                        <Icon name="ic:round-expand-more" rotate="90deg" flip="horizontal" color="#CF881D" width="24" height="24" />
                        <span class="text-[#CF881D] text-[18px] font-normal">Подробнее</span>
                    </div>
                </button>
            </div>
        </div>
